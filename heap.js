...
return(this.elements[i] =this.elements[j] ,this.elements[j] =e) } ) .call(this) } ,heapify_up:function( /* unary , node */i) { /* unary ; node */var p=i>>>1;
return( (this.above(this.elements[i] ,this.elements[p] ) ) && ( (function(it) {return(this.heapify_up(p) ) ,it} ) .call(this, (this.swap(p,i) ) ) ) ) } ,heapify_down:function( /* unary , node */i) {var l=i<<1;
var r=l+1;
